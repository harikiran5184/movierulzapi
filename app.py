...
@app.route("/<language>/<int:page>")
def get_home(language: str, page: int):
    page = 1 if page is None else page
    if language == "telugu":
        url = f"https://ww7.5movierulz.gd/telugu-movie/page/{page}"
    elif language == "hindi":
        url = f"https://ww7.5movierulz.gd/bollywood-movie-free/page/{page}"
    elif language == "tamil":
        url = f"https://ww7.5movierulz.gd/tamil-movie-free/page/{page}"
    elif language == "malayalam":
        url = f"https://ww7.5movierulz.gd/malayalam-movie-online/page/{page}"
    elif language == "english":
        url = "https://ww7.5movierulz.gd/category/hollywood-movie-2023/"
    else:
        url = None
    if url is not None:
        data = get_page(url)
